...
def torch2ethos(
    ...
    Args:
        ...
        metadata (dict | None, optional): Additional metadata to save alongside the exported model. Defaults to None.
        prefix (str, optional): Prefix for logging messages. Defaults to
